...
import { Send, Mic, ArrowLeft, Stethoscope, Loader2, MapPin, Video, PhoneOff, MicOff, RefreshCw, Volume2, Download, Paperclip, FileText, Camera, Check, VideoOff, SwitchCamera, UserCheck } from "lucide-react";

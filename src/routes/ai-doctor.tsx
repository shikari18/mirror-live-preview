...
export function DiseasePage() {
  ...
  return (
    <PhoneFrame>
      {/* Header */}
      <header className="px-5 pt-4 flex items-start justify-between border-b border-gray-200/80 bg-white/80 backdrop-blur-md pb-3 shadow-xs">
      ...
      {/* Hero Banner */}
      <section className="mx-5 mt-4 rounded-3xl bg-gradient-to-br from-[#0B2B1B] to-[#0F6236] text-white p-4.5 flex items-start gap-3 shadow-xl border border-emerald-500/20">
      ...
      {/* Diagnostic Form */}
      <section className="mx-5 mt-4 rounded-3xl border border-gray-200 p-5 bg-white shadow-md">
